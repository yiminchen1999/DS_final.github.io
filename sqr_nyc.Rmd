...
In our dataset, there are 5 main different kinds of activities reported which are foraging, running, eating, climbing and chasing. We make this plot to analyze central park squirrel activity by their primary fur color. 
...
We make this plot to analyze central park squirrel activity by their location (above ground, ground plane). 
