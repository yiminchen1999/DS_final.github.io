...
census =
  ...
  mutate(date=as.character(date),
         ...
         sounds = case_when( kuks == "TRUE" ~ "kuks",
                               quaas == "TRUE" ~ "quaas",
                               moans == "TRUE" ~ "moans"))%>%
          fur_color =case_when(primary_fur_color == "Grey" ~ '1'
          ,primary_fur_color == "Cinnamon" ~ '2',
          primary_fur_color == "Black" ~ '3',
          TRUE ~ '0'
          )
  
        #fur_color = case_when( primary_fur_color$grey == "grey" ~ "1",
                               #primary_fur_color$cinnamon == "cinnamon" ~ "2",
                               #primary_fur_color$black == "black" ~ "3")
