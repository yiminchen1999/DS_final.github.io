...
model_caret1 = train(long ~ hectare_squirrel_number + primary_fur_color + reaction + sounds, data = sq_df,
trControl = train,
method = 'lm',
na.action = na.pass)# fitting a regression line
model_caret1$finalModel
model_caret1
model_caret2 = train(lat ~ hectare_squirrel_number + primary_fur_color + reaction + sounds, data = sq_df,
trControl = train,
method = 'lm',
na.action = na.pass)# fitting a regression line
